...
- Heading structure changed.
  ...
  Got:      ['# Logging & Editing', '## Normal Mode Output', '### Normal Logfile Format', '## Enabling Debug Mode', '## Debug Configuration Options', '## Debug Logfile Format', '### Sample Debug Log', '## Interpreting Errors in Debug Mode']
-->
