...
Welcome to the advanced power user guide. This section covers configuration and performance topics that go beyond the defaults, including caching behavior, debug logging, and CPU-intensive callback patterns. It assumes you have already worked through the core concepts and are comfortable with the library's basics.
